        ...
        if (mode === 'update' && existingResource) {
            if (resourceType === 'topic') {
                setFormData(prev => ({
                    ...
                    subscriptions: existingResource.subscriptions
                ...
                setFormData(prev => ({
                    ...prev,
                    consumers: (existingResource.consumers || []).map(u => ({ name: u, isNew: false })),
                    producers: (existingResource.producers || []).map(u => ({ name: u, isNew: false }))
                }));
            }
        }
